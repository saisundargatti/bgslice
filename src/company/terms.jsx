const Terms = () => {
  const customStyle = {
    ...
    backgroundColor: "rgb(248, 249, 280)",
    padding: "40px",
    color: "black",
  };
  ...
  return (
    <div style={customStyle}>
      <h4>Welcome to bgslice.com!!</h4>
      <br />
      <p>
        These terms and conditions outline the rules and regulations for the use
        of bgslice.com's Website, located at saivenkatkumar365@gmail.com.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use bgslice.com if you do not agree to
      ...
      <p>
        ...
        the Company’s ter ms and conditions. "The Company", "Ourselves", "We",
      ...
      <p>
        We employ the use of cookies. By accessing bgslice.com, you agreed to
        use cookies in agreement with bgslice.com's Privacy Policy.{" "}
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated,bgslice.com and/or its licensors own the
        intellectual property rights for all material on bgslice.com. All
        intellectual property rights are reserved. You may access this from
        bgslice.com for your own personal use subject to restrictions set in
        these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from bgslice.com</li>
        <li>Sell, rent or sub-license material from bgslice.com</li>
        <li>Reproduce, duplicate or copy material from bgslice.com</li>
        <li>Redistribute content from bgslice.com</li>
      </ul>
      ...
      <p>
        ...
        website.bgslice.com does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of bgslice.com, its agents, and/or affiliates.
        ...
        bgslice.com shall not be liable for the Comments or for any liability,
      ...
      <p>
        bgslice.com reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant bgslice.com a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of bgslice.com, and (d) the link
      ...
      <p>
        ...
        e-mail to bgslice.com. Please include your name, your organization name,
      ...
      <p>
        No use of bgslice.com's logo or other artwork will be allowed for
